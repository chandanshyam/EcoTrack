...
function App() {
  ...
  return (
    <div className="min-h-screen text-brut-black font-sans p-4 sm:p-6 lg:p-8">
      <main className="container mx-auto">
        <header className="text-center mb-8">
            <div className="inline-block bg-brut-white border-2 border-brut-black p-3 rounded-md shadow-hard-sm mb-4">
                 <svg className="w-12 h-12 text-brut-green" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" fill="currentColor" /></svg>
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-brut-black">EcoTrack</h1>
            <p className="mt-2 text-lg text-gray-700">Your AI-Powered Sustainable Travel Planner</p>
        </header>
